...
const initialState: initialRootState = {
    pokemonsData: null, loading: false, error: undefined, currentPage: 1, singlePokemon: null, speciesUrl: null,


    pokemonInfo: null, typesList: null, uniqeIdPokemon: null,

    nextURL: "", previousURL: "", evolutionChain: null, total: 0
}
...
const pokemonSlice = createSlice({
    name: "Pokemon", initialState, reducers: {
